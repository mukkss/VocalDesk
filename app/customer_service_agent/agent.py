...
from .sub_agents.catalog_agent import catalog_agent
...
customer_service_agent = Agent(
    ...
    **Interaction History:**
    ...
    1. Catalog Agent
         - For questions about available courses, course details, and pricing
         - Provides information about the available coursees in the AI Developer Accelerator community
         - Can update state with new purchases
